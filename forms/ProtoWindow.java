 ...
 * @author Nathaniel
 */
public class ProtoWindow extends javax.swing.JFrame {

    /**
     * Creates new form ProtoWindow
     */
    public ProtoWindow() {
        initComponents();
    }
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(ProtoWindow.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new ProtoWindow().setVisible(true);
            }
        });
    }
